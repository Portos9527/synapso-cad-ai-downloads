# Synapso CAD AI — téléchargements
...
`Synapso-CAD-AI-0.1.0-Windows-x64.exe`.
...
Télécharger `Synapso-Fusion-Addin-0.1.0-Windows-Python314.zip`, extraire entièrement le ZIP,
...
La procédure détaillée se trouve aussi dans `README-INSTALLATION-FUSION.txt`.
